...
'Pluto', etc,) over the queue 'cs361planets'. After scraping the web the microservice will return the gravitational constant as a string over the the queue 'cs361gravity'. Below is an example call to contact my microservice. It is not currently running so you have to run it over local host

![image](https://user-images.githubusercontent.com/91440373/199132097-0c7ef42c-2809-4e44-9833-b376919ee248.png)
